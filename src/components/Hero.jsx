...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <source
          src="https://res.cloudinary.com/dci43ezfp/video/upload/v1781350217/hero_fm1ude.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div
        style={{
          ...
          zIndex: 2,
          background:
            "linear-gradient(to right, rgba(13,13,13,0.92) 0%, rgba(13,13,13,0.6) 60%, rgba(13,13,13,0.3) 100%)",
        }}
      />
